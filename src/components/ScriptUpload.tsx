...
const ScriptUpload = ({ onFileSelect }: ScriptUploadProps) => {
    ...
    const interval = setInterval(() => {
      setUploadProgress((prev) => {
        if (prev >= 100) {
          ...
          showSuccess("Document processed and ready for conversion.");
          return 100;
        }
        return prev + 10;
      });
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-2 bg-muted/50 p-3 rounded-lg border border-dashed">
        ...
        <p className="text-[10px] text-muted-foreground leading-relaxed">
          ScriptFlow will automatically extract scenes, characters, and dialogue formatting from your document using our proprietary narrative parser.
        </p>
      </div>
    </div>
  );
